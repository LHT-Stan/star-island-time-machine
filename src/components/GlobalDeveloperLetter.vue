      ...
      <div class="developer-letter-content" @click.stop>
        ...
        <div class="developer-body">
          <div class="developer-text">
            ...
            <p>还记得那个夏天吗？我们一起在ARK的世界里探险，你总是冲在我的前面，我也会默默在身边陪着你。那时的我们，以为时间会永远停留在那个美好的瞬间。</p>
            <p>虽然我们的之间故事有了不同的结局，但那些回忆依然是我心中最珍贵的宝藏。你教会了我什么是温柔，什么是包容，什么是无条件的关爱。</p>
            <p>现在的<span class="encrypted-text">我们<span class="encrypted">从恋人变</span>成了朋友</span>，这或许是最好的安排。我依然想要守护你的笑容，依然想要在你需要的时候陪伴在你身边。</p>
            <p>这个网站的每一行代码，都承载着我对你的祝福。愿你永远快乐，永远被爱包围，永远像个被宠爱的小朋友。</p>
            <p>悟空在星空中守护着你，<span class="encrypted">我其实一点也配不上你</span>而我，会在现实中默默为你加油。</p>
            <p>也恭喜发现了这个神秘的彩蛋。也成功的收集完了所有的时光密码：<span class="time-code">{{ timeCode }}</span></p>
            <p>这串数字代表着我们最珍贵的回忆 - 8月11日，我们在ARK相遇的日子，- 7月30日，是你的生日，我会永远铭记这一天。</p>
            <p>生日快乐，我最珍贵的朋友。</p>
            <p class="signature">白夜<br>2024年7月30日 ❤️</p>
          </div>
        </div>
      </div>
    </div>
